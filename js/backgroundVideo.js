...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        detect3d: function () {
            var el = document.createElement('div'), t, has3d,
            transforms = {
        ...
        scaleObject: function($video, $videoWrap) {
            ...
            // Scale object
            $video.width(this.options.originalVideoW);
            $video.height(this.options.originalVideoH);
        ...
        positionObject: function($video) {
            ...
            if(me.options.has3d) {
                ...
                $video.css('transform', 'translate3d('+ xPos +'px, ' + 0 + 'px, 0)');
            } else {
                $video.css(me.options.browserPrexix + 'transform', 'translate(-'+ xPos +'px, ' + yPos + 'px)');
                $video.css('transform', 'translate('+ xPos +'px, ' + 0 + 'px)');
            }
        },
