...
(function($) {
   ...
   */
  Spin.defaults = {
    source            : droneArray,    // Stitched source image or array of files
    width             : 800,    // actual display width
    height            : 514,    // actual display height
    ...
    frameTime         : 65,           // Time in ms between updates. 40 is exactly 25 FPS
